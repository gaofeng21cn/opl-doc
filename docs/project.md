...
- 只读 CLI doctor。
- OPL series 文档治理 workflow，内置 OPL、App、Native Workbench、OPL Flow、OPL Doc、MAS、MAG、RCA、OMA、BookForge 和 MAS Scholar Skills 这 11 仓 baseline；实际运行按当前 workspace/repo-local owner 扩展到存在且在范围内的 OPL-owned repo。
