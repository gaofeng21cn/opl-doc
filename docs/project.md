...
Purpose: `project`
State: `active_truth`
Machine boundary: 本文是人读项目定位；机器真相以 `.codex-plugin/plugin.json`、`skills/opl-doc-governance/SKILL.md`、`skills/opl-doc/SKILL.md`、`scripts/opl_doc_doctor.py` 和测试为准。
...
- `opl-doc` 短 skill 入口和 `opl-doc-governance` canonical/stable skill。
- 只读 CLI doctor。
